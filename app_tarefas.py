...
# Passo 3: Configurar a Janela Principal
janela = tk.Tk()
janela.title("GErenciador De Tarefas")
janela.configure(bg="white")
janela.geometry("500x600")

# Passo 4: Criar Funções para Gerenciamento de Tarefas
...
# Passo 5: Configurar a Entrada e Botão de Adição de Tarefa
...
# Passo 6: Criar a Lista de Tarefas com Barra de Rolagem
...
# Passo 7: Executar o Loop Principal
janela.mainloop()
